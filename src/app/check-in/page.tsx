  ...
  return (
    <section className="container section detail-page">
      ...
      <p className="lead narrow">
        MindTrack не ставит диагнозов. Используйте каталог тестов для выбора подходящей шкалы,
        а результаты из внешних сервисов сохраняйте локально в разделе импорта.
      </p>
